			...
			<div class="row justify-content-md-center">
				<div class="col-xs-12 col-md-10">
					<div id="registrarContainer" class="d-flex flex-column min-vh-100 justify-content-center">
						...
						<!-- Formulario -->
						<form action="AltaDeUsuario" method="POST" class="formulario" id="formulario" enctype="multipart/form-data">
							...
							<div class="formulario__grupo formulario__grupo-btn-registrarse">
								...
								<% if (request.getAttribute("registroExitoso") != null && (boolean) request.getAttribute("registroExitoso")) { %>
								  <div class="alert alert-success alert-dismissible fade show" role="alert">
								    ¡Registro exitoso! Tu cuenta ha sido creada con éxito.
